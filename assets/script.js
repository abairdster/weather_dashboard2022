...
function currentConditionsRequest(searchValue) {
    ...
    var queryURL = "http://" + searchValue "&units=imperial&appid=" + APIkey;
    ...
    $.ajax({
        ...
        var UVurl = "https://openweathermap.org/data/2.5/uvi?lat="+ lat + "&lon=" + lon + "&appid=" + APIkey;
